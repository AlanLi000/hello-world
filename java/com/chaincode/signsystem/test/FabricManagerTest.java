package com.chaincode.signsystem.test;

import com.chaincode.signsystem.fabric.ChaincodeManager;
import com.chaincode.signsystem.fabric.FabricConfig;
import com.chaincode.signsystem.fabric.bean.Chaincode;
import com.chaincode.signsystem.fabric.bean.Orderers;
import com.chaincode.signsystem.fabric.bean.Peers;
...
public class FabricManagerTest {
    ...
    private FabricConfig getConfig(Integer type) {
        ...
        if (type==1){
            config.setChaincode(getChaincode(channelName, "sign"
                , "github.com/hyperledger/fabric/aberic/chaincode/go/sign/", version));
        }else {
    ...
    private Orderers getOrderers() {
        ...
        //47.101.207.241
        //172.19.1.150
        orderer.addOrderer("orderer.example.com", "grpc://47.101.207.241:7050");
    ...
    private Peers getPeers() {
        ...
        peers.addPeer("peer0.org1.example.com", "peer1.org1.example.com",
                "grpc://47.101.207.241:7051", "grpc://47.101.207.241:7051", "http://47.101.207.241:7054");
        return peers;
    }
